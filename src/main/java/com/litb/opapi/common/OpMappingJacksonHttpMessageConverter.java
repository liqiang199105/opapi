...
public class OpMappingJacksonHttpMessageConverter extends
AbstractHttpMessageConverter<Object> {

	public static final Charset DEFAULT_CHARSET = Charset.forName("UTF-8");


	private static final Logger logger = LoggerFactory.getLogger(OpMappingJacksonHttpMessageConverter.class);
	 ...
	 */
	public OpMappingJacksonHttpMessageConverter() {
